...
const image = importFile(require.context('../img/true-daily-pnl', false, /\.(png|jpe?g|svg)$/));
        ...
        <Container>
          <Grid container spacing={3}>
            <Grid item xs={12} md={6}>
              ...
              <Hidden only={['xs', 'sm']}>
                <Button variant="contained" color="primary" style={{ marginTop: "2em" }} to='/portfolio/case-study/true-daily-pnl#application-overview' component={RouterLink}>View Case Study</Button>
              </Hidden>
            </Grid>
            <Hidden only={['md', 'lg', 'xl']}>
              ...
              <Grid item xs={12} md={6}>
                <Button variant="contained" color="primary" to='/portfolio/case-study/true-daily-pnl#title' component={RouterLink}>View Case Study</Button>
              </Grid>
            </Hidden>
            <Hidden only={['xs', 'sm']}>
              <Grid item xs={12} md={6}>
