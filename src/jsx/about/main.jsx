...
const resume = importFile(require.context('../../file', false, /\.(pdf)$/));

const About = () => {
  return (
    <>
      <Box sx={{ minHeight: "100vh", py: "80px", backgroundColor: blueGrey[50] }}>
          ...
          <Grid item xs="auto">
            <Container>
              ...
              <Typography variant="h5" style={{ marginTop: "1em" }}>
                I have been working as a designer for 10+ years, translating business goals into products that satisfy user needs. An avid learner, I am always seeking out opportunities to learn &amp; contribute towards a user-centered product development.
              </Typography>
            </Container>
          </Grid>
          <Grid item xs="auto">
              ...
              <Grid container spacing={6}>
                ...
                <Grid item xs="3">
                  <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={"auto"}>
                      <Typography size="large" style={{ marginTop: "-5px" }}>k.shaiz@gmail.com</Typography>
                    </Grid>
                    <Grid item xs={12}>
                      <Button variant="contained" color="primary" size="large" onClick={() => {downloadFile( resume, "resume", "pdf")}}>Download Resume</Button>
                    </Grid>
                  </Grid>
                </Grid>
              </Grid>
